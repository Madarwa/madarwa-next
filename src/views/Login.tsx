...
const Login = ({ mode }: { mode: SystemMode }) => {
  ...
  return (
    <div className='flex bs-full justify-center'>
      ...
      >
        <div>
          <p className='p-10 pb-2 font-semibold text-3xl'>Welcome to madaRWA</p>
          <p className='pl-10 pt-2'>
            madaRWA is a Starknet L3 chain specifically designed for the Real World Asset (RWA) ecosystem.
            <br /> Here,
            <br />
            <i className='tabler-point-filled  bg-black align-bottom ' /> Only users who have completed KYC verification
            can buy or sell security and RWA tokens.
            <br />
        ...
        <div className='flex flex-col gap-6 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-8 sm:mbs-11 md:mbs-0'>
          <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-6'>
            <Button fullWidth variant='contained' type='submit'>
              <i className='tabler-point-filled stroke-success bg-success align-bottom' /> Click Here To Connect
            </Button>
          </form>
        </div>
      </div>
