...
const VerticalLayoutRight = (props: VerticalLayoutProps) => {
  // Props
  const { navbar, footer, navigation, children } = props

  return (
    <div className={classnames(verticalLayoutClasses.root, 'flex flex-auto flex-row-reverse')}>
      {navigation || null}
...
export default VerticalLayoutRight
